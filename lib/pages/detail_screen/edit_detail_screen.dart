...
class _EditDetailScreenState extends State<EditDetailScreen> {
  ...
  void editProductFromCart(String nameProduct, int price, int totalPrice,
      int qtt, String uid, String idOrder) {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(context,
                MaterialPageRoute(builder: (builder) => Cart_screenPage()));
          },
        ),
        actions: [
          Ink(
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () {
                        editProductFromCart(widget.nameProduct, widget.harga,
                            dataHarga, quantity, idUser, widget.pesananId);
                      },
                      child: Text('Beli',
